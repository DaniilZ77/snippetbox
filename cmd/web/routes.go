...
import (
	...
	"github.com/DaniilZ77/snippetbox/ui"
...
func (app *application) routes() http.Handler {
	...
	router.Handler(http.MethodGet, "/snippet/create", protected.ThenFunc(app.showCreateSnippetForm))
	router.Handler(http.MethodPost, "/snippet/create", protected.ThenFunc(app.createSnippet))
